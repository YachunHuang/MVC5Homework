namespace MVC5Homework.Models
{
	public static class RepositoryHelper
	{
		...
		public static CustomViewRepository GetCustomViewRepository()
		{
			var repository = new CustomViewRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static CustomViewRepository GetCustomViewRepository(IUnitOfWork unitOfWork)
		{
			var repository = new CustomViewRepository();
